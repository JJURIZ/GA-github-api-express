...
app.get("/me", (req, res) => {
  ...
  axios.get("https://api.github.com/users/jjuriz").then((response) => {
...
app.get("/nitish", (req, res) => {
  axios.get("https://api.github.com/users/nitishdayal").then((response) => {
    const data = response.data;
    const nitishObject = {
      login: data.login,
      url: data.html_url,
...
app.get("/simone", (req, res) => {
  axios.get("https://api.github.com/users/sschneeberg").then((response) => {
    const data = response.data;
    const simoneObject = {
      login: data.login,
      url: data.html_url,
...
app.get("/alan", (req, res) => {
  axios.get("https://api.github.com/users/delayedaa").then((response) => {
    const data = response.data;
    const alanObject = {
      login: data.login,
      url: data.html_url,
...
app.get("/corey", (req, res) => {
  axios.get("https://api.github.com/users/CoreyWilson319").then((response) => {
    const data = response.data;
    const coreyObject = {
      login: data.login,
      url: data.html_url,
